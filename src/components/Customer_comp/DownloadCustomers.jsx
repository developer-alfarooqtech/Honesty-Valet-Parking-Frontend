...
import { downloadCustomers } from "../../service/customerService";
...
const createHeader = () => {
  ...
  title.textContent = "Customers List";
...
const createTableHeader = () => {
  ...
  const headers = ["Name", "Code", "Email", "Phone", "Address"];
...
// Create table row
const createTableRow = (customer, index) => {
...
const createDataTable = (data) => {
  ...
  data.forEach((customer, index) => {
    const row = createTableRow(customer, index);
...
export const handleDownloadCustomersPDF = async ({
  setExportingPDF,
  search,
}) => {
  try {
