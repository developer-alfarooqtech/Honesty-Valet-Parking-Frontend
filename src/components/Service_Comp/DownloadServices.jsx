...
import { downloadServices } from "../../service/productService";
...
const createHeader = () => {
  ...
  title.textContent = "Services List";
...
const createTableHeader = () => {
  ...
  const headers = ["Service", "Code", "Price"];
...
// Create table row
const createTableRow = (service, index) => {
...
const createDataTable = (data) => {
  ...
  data.forEach((service, index) => {
    const row = createTableRow(service, index);
...
export const handleDownloadServicesPDF = async ({
  setExportingPDF,
  search,
}) => {
  try {
