...
import { downloadSuppliers } from "../../service/supplierService";
...
const createHeader = () => {
  ...
  title.textContent = "Suppliers List";
...
// Create table row
const createTableRow = (supplier, index) => {
...
export const handleDownloadSupplierPDF = async ({
  setExportingPDF,
}) => {
  try {
    ...
    // Fetch invoice data
    const response = await downloadSuppliers();
